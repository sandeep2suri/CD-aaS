...
import com.incedo.app.repository.TeamRepository;
import com.incedo.app.service.TeamService;
import com.incedo.app.web.rest.errors.ExceptionTranslator;
...
import static com.incedo.app.web.rest.TestUtil.createFormattingConversionService;
...
public class TeamResourceIT {
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getClientName()).isEqualTo(DEFAULT_CLIENT_NAME);
    }
    ...
    public void updateTeam() throws Exception {
        ...
        assertThat(testTeam.getClientName()).isEqualTo(UPDATED_CLIENT_NAME);
    }
