...
import com.incedo.app.repository.EmployeeRepository;
import com.incedo.app.security.SecurityUtils;
...
/**
 * REST controller for managing {@link com.incedo.app.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    public ResponseEntity<List<Employee>> getAllEmployees(Pageable pageable) {
        ...
        if(loggedUser.get().equals("admin")) {
        	page = employeeRepository.findAll(pageable);
        }
        else {
        	page = employeeRepository.findByManagerIsCurrentUser(pageable);
        }       
    ...
    public ResponseEntity<List<Employee>>  getEmployeeByTeam(@PathVariable Long id) {
        log.debug("REST request to get Employee : {}", id);
        List<Employee> employees = employeeRepository.findAllByTeamId(id);
